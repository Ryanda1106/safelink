...
var xxx=null;
if(x=="1"){xxx="cara-instal-windows-10-cukk.html"}
if(x=="2"){xxx="cara-mengatur-ip-address-lan-cukk.html"}
if(x=="3"){xxx="membuka-menyimpan-atau-menghapus-file-cukk.html"}
if(x=="4"){xxx="dhcp-server-dan-dhcp-client-cukk.html"}
a_to_ve[i].href="https://bloggperfect.blogspot.com/2019/04/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
